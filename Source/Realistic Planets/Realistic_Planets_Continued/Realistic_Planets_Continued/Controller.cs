	...
	public class Controller : Mod
	{
		...
		private void Init()
		{
            ...
            ModMethodData fcData = new ModMethodData(
				packageId: "thereallemon.factioncontrol",
            ...
            //currently broken as there is no 1.4 port for Configurable Maps but I will leave this here in case someone updates it to 1.4
